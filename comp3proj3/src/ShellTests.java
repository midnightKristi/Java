...
public class ShellTests {
    ...
    public static void testAlmostSorted(){
        ...
        for(int k = 1; k < 6; k++){
            System.out.println("-- SHELL SORT TIME TEST - ALMOST SORTED ARRAY --");
