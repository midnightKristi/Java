 ...
 *           https://github.com/wcbrown86/Java/blob/566476f0a1aec439baf629ca80f2a3ada15276f3/Sorting/RandomGenerator.java
 *
...
public class RandomGenerator {
     ...
     *
     */
    public static void makeTextFile(int[] arr2) {

        try{
            // Creates a buffer to write the information to a file.
            BufferedWriter output = null;
            file = "RandomNumber"+ arr2.length + ".txt";
    ...
    public static void makeAlmostSortedTextFile(int[] arr2) {
        String file;
        try{
            // Creates a buffer to write the information to a file.
            BufferedWriter output = null;
            file = "AlmostSorted"+ arr2.length + ".txt";
            output = new BufferedWriter(new FileWriter(file));
    ...
    /*
     *
     * This function takes in an integer that represents the number of
